<template>
    <div>
        ...
        >
            <div class="min-h-[100vh] w-full px-24 flex items-center justify-center">
                <div class="w-[40%]">
                    <div class="form-container">
                        ...
                        <form class="form">
                            ...
                            <div class="input-group">
                                ...
                                <div class="relative">
                                    ...
                                    />
                                    <button
                                        @click.prevent="isShowPasswordConfirmation = !isShowPasswordConfirmation"
                        ...
                        <p class="signin">
                            ...
                            <router-link :to="{ name: 'auth-login' }" class="">Sign in</router-link>
                        </p>
                    </div>
                </div>
            </div>
